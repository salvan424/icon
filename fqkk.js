...
let url = {
        url : "http://m."+fqkkurl.match(/m.(.*?).xyz/)[1]+".top/reada/finishTask",
...
function fqkk2(timeout = 0) {
  return new Promise((resolve) => {
let url = {
        url : "http://m."+fqkkurl.match(/m.(.*?).xyz/)[1]+".top/reada/jump?key="+fqkey,
        headers : JSON.parse(fqkkhd),
...
let url = {
        url : "http://m."+fqkkurl.match(/m.(.*?).xyz/)[1]+".top/reada/getTask",
        headers : JSON.parse(fqkkhd),
        body : '',}
      $.post(url, async (err, resp, data) => {
        try {
...
function fqkktx(timeout = 0) {
  return new Promise((resolve) => {
let url = {
        url : "http://m."+fqkkurl.match(/m.(.*?).xyz/)[1]+".top/withdrawal/doWithdraw",
        headers : JSON.parse(fqkkhd),
        body : 'amount='+fqtx,}
      $.post(url, async (err, resp, data) => {
        try {
...
function fqread(timeout = 0) {
  return new Promise((resolve) => {
let url = {
        url : "http://m."+fqkkurl.match(/m.(.*?).xyz/)[1]+".top/reada/toRead?sign="+fqkey+"&for=",
        headers : JSON.parse(fqkkhd),
   }
      $.get(url, async (err, resp, data) => {
        try {
